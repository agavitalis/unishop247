...
<div class="logo ">
	<a href="index.php">
            ...
            <img class="resizelogo" src="./img/logo.png">
...
<!-- ============================================================= SEARCH AREA : END ============================================================= -->				</div><!-- /.top-search-holder -->
				...
				<div class="col-xs-12 col-sm-12 col-md-3 animate-dropdown top-cart-row pullcart">
	...
	?>
					...
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<h3 class="name"><a href="index.php?page-detail"><?php echo $row['productName']; ?></a></h3>
                                                        <div class="price">&#8358; <?php echo number_format($row['productPrice']+$row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
						</div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
                                    ...
                                    <span class="text">Total :</span><span class='price'>&#8358; <?php echo number_format($_SESSION['tp']="$totalprice"). ".00"; ?></span>
