...
$query=mysqli_query($con,"insert into users(name,email,contactno,password,referral) values('$name','$email','$contactno','$password','$referral')");
if($query)
{
	//log this registered user in
                        ...
                        <form class="register-form outer-top-xs" role="form" method="post" name="register"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control unicase-form-control text-input" id="contactno"
                                    name="contactno" maxlength="11" required>
                            </div>
							...
							<hr>
							<div class="form-group">
                                <label class="info-title" for="confirmpassword">Referral Email(Optional)</label>
