...
?>
				...
				<tr>
					<td class="col-md-2"><img src="admin/productimages/<?php echo htmlentities($row['proid']);?>/<?php echo htmlentities($row['pimage']);?>" alt="<?php echo htmlentities($row['pname']);?>" width="60" height="60"></td>
					<td class="col-md-6">
...
?>
						...
						<?php } ?>
						<div class="price">&#8358;  
							<?php echo number_format($row['pprice']);?>.00
